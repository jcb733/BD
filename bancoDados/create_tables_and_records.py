...
def run():
    ...
    with open("/home/labdatabase/Workplace/sql/scripts.sql") as f:
        query_create = f.read()
    ...
    with open("/home/labdatabase/Workplace/sql/dadosMocados.sql") as f:
    ...
    #with open("/home/labdatabase/Workplace/sql/exemplosDeInserts.sql") as f:
